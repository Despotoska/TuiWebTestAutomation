import static org.junit.Assert.assertEquals;
	...
	public class TuiShortHaul2Adult2Children 
	{
		...
		@Test
		  public void TuiSEShortHaul2Adults2Children() throws Exception
		  {
...
//			    Choose how many passengers will travel(2+2)
			    ...
			    Select dropDown1ChildAges = new Select (wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='ages clearfix'] //select[@data-index='1']"))));
			    dropDown1ChildAges.selectByValue("7");
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[class='children clearfix'] i[class='icon icon-plus add']"))).click();
			    Select dropDown2ChildAges = new Select (wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='ages clearfix'] //select[@data-index='2']"))));
			    dropDown2ChildAges.selectByValue("4");
...
//			    Fill the info for the passenger 3(child 1)
...
//			    Fill the info for the passenger 4(child 2)
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='form-section'] //input[@type='text' and @placeholder='Resen‰r 4' ]"))).sendKeys(TestDataWeb.PASSENGERNAME4);
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='form-section'] //input[@data-ng-model='passenger.familyName' and @data-passenger-index='3']"))).sendKeys(TestDataWeb.PASSENGERSURNAME4);
//				Date of birth passenger 3
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder='≈≈≈≈-MM-DD' and @data-ng-model='passenger.dob' and @data-passenger-index='3']"))).sendKeys(TestDataWeb.DATEOFBIRTH4);
//			    Gender passenger 3
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@data-watch-model='passenger.gender' and @name='sex3' and @value='"+TestDataWeb.GENDER4+"']"))).click();
...
//			    Food onboard passenger 4
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[@class='radio-inline ng-binding'] //input[@name='LIBO-0000012593' and @value='no']"))).click();
...
//			    Cancelation and rebooking protection passenger 2
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='C-CANCELLATIONINSURANCE1' and @value='no']"))).click();
//			    Cancelation and rebooking protection passenger 3
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='C-CANCELLATIONINSURANCE2' and @value='no']"))).click();
//			    Cancelation and rebooking protection passenger 4
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='C-CANCELLATIONINSURANCE3' and @value='no']"))).click();
...
//			    Travel insurance passenger 4
			    wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='C-TRAVELINSURANCE3' and @value='no']"))).click();
